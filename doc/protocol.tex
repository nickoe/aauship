...
\bitbox{1}{\$} \bitbox{5}{DevID} \bitbox{5}{MsgID} \raisebox{-1mm}{$\underbrace{\raisebox{1mm} {\bitbox{16}{Data field }}}_\mathrm{Variable\ length}$}\bitbox{4}{CRC16} \bitbox{2}{\texttt{\textbackslash n}  }
\end{bytefield}
\label{fig:bytefield}
