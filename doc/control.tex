...
The \emph{Roll} and the \empg{Pitch} are caused by \emph{perpendicular} and \emph{paralell} external forces attacking the hull of the ship, in respect to the motion.
