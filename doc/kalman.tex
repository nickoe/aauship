...
\begin{figure}[htbp]
	...
	\caption{Simulation of the \ac{KF} with reference signal given as: 1 m/s and angle as $sin(\theta)$, with 0.2 amplitude and 0.001 Hz frequency for 10000 samples. The system gains the measurements when no \ac{GPS} samples are present with 0.}
	\label{fig:kalmanB}
\end{figure}
