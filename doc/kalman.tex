...
The variance and mean of the torque are seen as a zero-mean process, as the ship mainly sails straight forward, but then the variance changes as the ship turns.  